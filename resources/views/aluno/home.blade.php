            ...
            <div class="col-md-4">
                <div class="card shadow h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('comprovantes.create') }}" class="btn btn-primary mt-auto">Enviar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('comprovantes.index') }}" class="btn btn-primary mt-auto">Visualizar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('declaracoes.create') }}" class="btn btn-primary mt-auto">Gerar</a>
                    </div>
                </div>
            </div>
        </div>
